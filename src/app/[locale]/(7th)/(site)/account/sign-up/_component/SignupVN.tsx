...
import { PrivacyPolicyHtml } from '../../../home/rg-membership/privacy-policy/PrivacyPolicyHtml'
import { TermsOfServiceHtml } from '../../../home/rg-membership/terms-of-service/TermsOfServiceHtml'
import {
  BASE_TIME,
  CheckField,
  isValidateEmailVn,
  ...
  return (
    <Modal
      ...
      <div className="container">
        {type === 'TermsOfService' && <TermsOfServiceHtml />}
        {type === 'PrivacyPolicy' && <PrivacyPolicyHtml />}
      </div>
    </Modal>
  )
}
