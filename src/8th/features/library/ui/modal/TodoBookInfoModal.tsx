...
export default function TodoBookInfoModal({
  imgSrc,
  title,
  bookCode,
  levelRoundId,
  ...
  const [currentStudyId, setCurrentStudyId] = useState<string | undefined>(
    studyId,
  )

  const { data: bookInfo, isLoading: isBookInfoLoading } =
    useTodoBookDetailInfo({
      levelRoundId,
