window.TRANSLATE_EN = {
  ...
  table: {
    ...
    pbook_quiz: {
      menu: "P-BOOK QUIZ",
      desc: "Learning content for paper books with online post-reading quizzes.",
    ...
    calendar: {
      menu: "CALENDAR",
      desc: "Check monthly attendance and daily learning history.",
      tip: "Click a date in the history to see the books studied on that day."
    },
    more: {
      menu: "MORE",
      desc: "View Level Test history, failed books, and various settings.",
      tip: "Replay Level Test, review books below 70 points, and configure the home screen."
    }
  },
  tip: { badge: "TIP" },
  video: { logo_alt: "Watch usage guide video" }
};
